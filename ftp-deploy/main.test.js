...
describe("FTP sync commands", () => {
    ...
    test("upload file", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const syncProvider = new syncProvider_1.FTPSyncProvider(mockClient, mockedLogger, mockedTimings, "local-dir/", "server-dir/", "state-name", false);
...
describe("getLocalFiles", () => {
    ...
    test("exclude node_modules", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const filteredStats = files.filter(file => localFiles_1.applyExcludeFilter(file, module_1.excludeDefaults));
    ...
    test("exclude none", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const filteredStats = files.filter(file => localFiles_1.applyExcludeFilter(file, []));
    ...
    test("exclude all js files", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const filteredStats = files.filter(file => localFiles_1.applyExcludeFilter(file, ["*.js"]));
    ...
    test("exclude globbed folder", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const filteredStats = files.filter(file => localFiles_1.applyExcludeFilter(file, ["**/folder/**"]));
